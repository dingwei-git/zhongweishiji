...
public class AESUtil {
    ...
    private static final String ENCODE_RULES = "jaws";
    ...
    public static String aesEncode(String content) {
        try {
            ...
            //11.将字符串返回
            return getURLEncoderString(aesEncode);
    ...
    public static String aesDecode(String content) {
        try {
            content = URLDecoderString(content);
            //1.构造密钥生成器，指定为AES算法,不区分大小写
            ...
            throw new BusinessException(BusinessErrorEnum.PSS_FILE_PATH_INVALID);
        }
    }
