 ...
 * @since 2019-08-01
 */
public class TblCameraDetailOriginalData implements Serializable {
    /**
     * 注释内容
     */
     ...
     * 丢弃标识null:需采集 1: 丢弃
     */
    private String discardCollection;
    ...
    public String getDiscardCollection() {
        return discardCollection;
    }

    public void setDiscardCollection(String discardCollection) {
        this.discardCollection = discardCollection;
    }
