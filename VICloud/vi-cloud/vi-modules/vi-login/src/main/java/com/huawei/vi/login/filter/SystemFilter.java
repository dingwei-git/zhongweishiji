package com.huawei.vi.login.filter;
...
//            }
            ...
            if (url.indexOf("modify_pwd") >= 0||
                ...
                try {
                    ...
                    if (claims == null) {
                        throw new BusinessException(BusinessErrorEnum.UMS_TOKEN_OVERDUE);
                    }
                    ...
                    if(StringUtils.isEmpty(userId)){
                        throw new BusinessException(BusinessErrorEnum.UMS_ACCOUNT_INVALID);
                    }
